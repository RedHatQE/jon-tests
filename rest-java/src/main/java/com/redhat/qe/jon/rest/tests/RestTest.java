...
public class RestTest extends RestClient{
	...
	public void checkPlatformOperations(@Optional String parentId) throws ParseException{
		...
		result = this.getReponseWithParams(webResource, URIs.OPERATION_DEFINITIONS.getUri(), queryParams);
	...
	@Parameters({ "parent.id"})
	@Test (groups="restClientJava")
	public void checkGroup(@Optional String parentId) throws ParseException{
		//GroupRest gr = new GroupRest();
		}
