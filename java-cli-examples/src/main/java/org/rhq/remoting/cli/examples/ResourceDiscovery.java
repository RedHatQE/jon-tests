...
public class ResourceDiscovery {
    ...
    public Resource[] discoveryQueue(RemoteClient client) {
    ...
    public void importAllResources(RemoteClient client) {
	Resource[] resources = discoveryQueue(client);
    ...
    public void importResources(RemoteClient client, Resource[] resources) {
    ...
    public Resource[] findResources(RemoteClient client, String resourceTypeName) {
	ResourceCriteria criteria = new ResourceCriteria();
    ...
    public Resource[] findResources(RemoteClient client, Integer... ids) {
	ResourceCriteria criteria = new ResourceCriteria();
	criteria.addFilterInventoryStatus(InventoryStatus.COMMITTED);
	criteria.addFilterIds(ids);
	PageList<Resource> resources = client.getResourceManager().findResourcesByCriteria(client.getSubject(), criteria);
