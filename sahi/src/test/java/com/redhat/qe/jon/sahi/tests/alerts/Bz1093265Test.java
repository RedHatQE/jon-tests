...
import com.redhat.qe.jon.sahi.base.administration.AlertDefTemplatesPage;
...
public class Bz1093265Test extends OnAgentSahiTestScript {
    ...
    @Test
    public void createAlarmDefTemplateTest(){
        ...
        AlertDefTemplatesPage alertDefTemplatesPage = new AlertDefTemplatesPage(sahiTasks);
        AlertDefinitionPageSnippet alertDefSnippet = alertDefTemplatesPage.navigate().editTemplate("RHQ Agent");
        alertDefSnippet.deleteAlertDefinition(ALERT_DEF_NAME1);
        ...
        alertDefSnippet.createAlarmDefinition(ALERT_DEF_NAME1).
    ...
    @Test(dependsOnMethods="createAlarmDefTemplateTest")
    public void quicklyEditAlarmDefTemplateTest(){
        // we can't use abstraction layer here because we want to be quick to reproduce the issue
        Editor editor = new Editor(sahiTasks);
        AlertDefTemplatesPage alertDefTemplatesPage = new AlertDefTemplatesPage(sahiTasks);
        AlertDefinitionPageSnippet alertDefSnippet = alertDefTemplatesPage.navigate().editTemplate("RHQ Agent");
        alertDefSnippet.editAlertDefinition(ALERT_DEF_NAME1);
