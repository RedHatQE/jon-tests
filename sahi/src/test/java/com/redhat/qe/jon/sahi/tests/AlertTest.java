...
public class AlertTest extends SahiTestScript{
	...
	public Object[][] getAlertCreationData(){
		...
		String defaultConditionType 	= "Condition Type :";
		String defaultMetricType		= "Metric :";
		String defaultComparator		= "Comparator :";
		String notoficationSender		= "Notification Sender :|selectItemText";
		...
		map.put(CONDITION_DROPDOWNS, defaultConditionType+"-->Measurement Absolute Value Threshold,"+defaultMetricType+"-->Agent-Server Clock Difference");
		map.put(CONDITION_TEXTBOX, "metricAbsoluteValue=500000");
		map.put(NOTIFICATION_TYPE, notoficationSender+"-->System Users");
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, defaultConditionType+"-->Measurement Absolute Value Threshold,"+defaultMetricType+"-->JVM Active Threads,"+defaultComparator+"-->> (Greater Than)");
...
/* disabling this one, it requires scrolling, not worth to implement right now
		//map.put(RESOURCE_NAME, "Servers=RHQ Agent");
