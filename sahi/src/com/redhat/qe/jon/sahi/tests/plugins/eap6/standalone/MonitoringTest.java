...
public class MonitoringTest extends AS7PluginSahiTestScript {
    ...
    public void specifyMonitoringIntervalTest() {        
        ...
        //log.fine(sahiTasks.cell(4).in(sahiTasks.cell("Maximum request time").parentNode("TR")).getText());
        //log.fine(sahiTasks.cell(3).in(sahiTasks.cell("Maximum request time").parentNode("TR")).getText());
