...
public class AlertTest extends SahiTestScript{
	...
	public Object[][] getAlertCreationData(){
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, "Availability Change-->Measurement Absolute Value Threshold,Agent-Server Clock Difference-->JVM Total Memory");
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, "Availability Change-->Measurement Absolute Value Threshold,Agent-Server Clock Difference-->Number of Commands Received but Failed per Minute");
		map.put(CONDITION_TEXTBOX, "metricAbsoluteValue=500000");
		map.put(NOTIFICATION_TYPE, "System Users");
		map.put(NOTIFICATION_DATA, "rhqadmin");		
		map.put(RECOVERY_ALERT_DISABLE, "disableWhenFired=yes");
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, "Availability Change-->Measurement Absolute Value Threshold,Agent-Server Clock Difference-->Number of Commands Received Successfully per Minute");
		map.put(CONDITION_TEXTBOX, "metricAbsoluteValue=500000");
		map.put(NOTIFICATION_TYPE, "System Users");
		map.put(NOTIFICATION_DATA, "rhqadmin");		
		map.put(RECOVERY_ALERT_DISABLE, "disableWhenFired=yes");
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, "Availability Change-->Measurement Absolute Value Threshold,Agent-Server Clock Difference-->Number of Commands Spooled To Disk");
		map.put(CONDITION_TEXTBOX, "metricAbsoluteValue=500000");
		map.put(NOTIFICATION_TYPE, "System Users");
		map.put(NOTIFICATION_DATA, "rhqadmin");		
		map.put(RECOVERY_ALERT_DISABLE, "disableWhenFired=yes");
		...
		map.put(ALERT_DESCRIPTION, "Generated by automation");
		map.put(CONDITION_DROPDOWNS, "Availability Change-->Measurement Absolute Value Threshold,Agent-Server Clock Difference-->Number of Commands Successfully Sent per Minute");
		map.put(CONDITION_TEXTBOX, "metricAbsoluteValue=500000");
		map.put(NOTIFICATION_TYPE, "System Users");
		map.put(NOTIFICATION_DATA, "rhqadmin");		
		map.put(RECOVERY_ALERT_DISABLE, "disableWhenFired=yes");
