...
public class BuildVersionInfoTest extends SahiTestScript {
	...
	public void getBuildInfo(){
		...
		Reporter.log("<b>"+buildInfo.get("version")+"</b>");
		Reporter.log("<b>"+buildInfo.get("build.number")+"</b>");
		Reporter.log("<b>"+buildInfo.get("gwt.version")+"</b>");
		Reporter.log("<b>"+buildInfo.get("smartgwt.version")+"</b>");
	}
}